...
exports.reserveFunctions = exports.getReserveStatus = void 0;
const functions = __importStar(require("firebase-functions"));
const firebase_1 = require("../config/firebase");
const firestore = (0, firebase_1.getFirestoreInstance)();
exports.getReserveStatus = functions.https.onCall(async (data, context) => {
    try {
...
exports.reserveFunctions = {
    getReserveStatus: exports.getReserveStatus
};
