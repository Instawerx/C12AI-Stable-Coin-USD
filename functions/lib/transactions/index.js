...
exports.transactionFunctions = exports.processCrossChainTransfer = exports.monitorTransactionStatus = exports.processRedeemRequest = exports.processMintRequest = void 0;
...
exports.processMintRequest = functions.firestore
    ...
    try {
        ...
        await (0, validation_1.validateTransactionData)(mintData, 'mint');
        // Check user rate limits
        await (0, rateLimit_1.checkRateLimit)('MINT_OPERATIONS', mintData.userId, 5, 3600); // 5 per hour
        ...
        await (0, notifications_1.sendNotification)(mintData.userId, {
...
exports.processRedeemRequest = functions.firestore
    ...
    try {
        ...
        await (0, validation_1.validateTransactionData)(redeemData, 'redeem');
        // Check user rate limits
        await (0, rateLimit_1.checkRateLimit)('REDEEM_OPERATIONS', redeemData.userId, 3, 3600); // 3 per hour
        // Update status to processing
        await snapshot.ref.update({
            status: 'BURN_PENDING',
            updatedAt: admin.firestore.FieldValue.serverTimestamp()
        ...
        // Send notification
        await (0, notifications_1.sendNotification)(redeemData.userId, {
...
exports.monitorTransactionStatus = functions.firestore
    ...
    try {
        ...
        if (userId) {
            ...
            if (notificationData) {
                await (0, notifications_1.sendNotification)(userId, notificationData);
            }
        }
        // Audit log
        await (0, audit_1.createAuditLog)({
...
exports.processCrossChainTransfer = functions.firestore
...
function getCrossChainStatusMessage(status, fromChain, toChain) {
    switch (status) {
        case 'INITIATED':
...
exports.transactionFunctions = {
    processMintRequest: exports.processMintRequest,
    processRedeemRequest: exports.processRedeemRequest,
    monitorTransactionStatus: exports.monitorTransactionStatus,
    processCrossChainTransfer: exports.processCrossChainTransfer
};
