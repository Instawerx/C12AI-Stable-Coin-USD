...
exports.complianceFunctions = exports.processKYCDocument = exports.sanctionsScreening = exports.transactionMonitoring = exports.riskAssessment = void 0;
...
exports.riskAssessment = functions.firestore
    ...
    try {
        ...
        if (newRiskScore > 75) {
            await (0, audit_1.createComplianceAlert)(userId, 'HIGH_RISK_SCORE', `User risk score increased to ${newRiskScore}`, newRiskScore, flags);
        }
        ...
        if (newRiskScore > 90) {
            ...
            // Notify user
            await (0, notifications_1.sendNotification)(userId, {
...
exports.transactionMonitoring = functions.firestore
    ...
    try {
        ...
        if (userDoc.exists) {
            ...
            const userAge = Date.now() - ((_a = userData === null || userData === void 0 ? void 0 : userData.createdAt) === null || _a === void 0 ? void 0 : _a.toDate().getTime());
            ...
            if ((userData === null || userData === void 0 ? void 0 : userData.country) && highRiskCountries.includes(userData.country)) {
                riskScore += 20;
        ...
        if (riskScore > 20 || flags.length > 0) {
            ...
            if (userDoc.exists) {
                const currentRiskScore = ((_b = userDoc.data()) === null || _b === void 0 ? void 0 : _b.riskScore) || 0;
...
// Sanctions screening
exports.sanctionsScreening = functions.https.onCall(async (data, context) => {
    try {
        if (!context.auth) {
        ...
        if (isSanctioned) {
            ...
            if (userId) {
                ...
                await (0, audit_1.createComplianceAlert)(userId, 'SANCTIONS_HIT', `Address ${address} appears on sanctions list`, 100, ['sanctioned', 'blocked']);
            }
            // Audit log
            await (0, audit_1.createAuditLog)({
...
// Helper functions
async function checkSanctionsList(address) {
...
async function verifyDocument(storageUrl, type) {
...
exports.complianceFunctions = {
    riskAssessment: exports.riskAssessment,
    transactionMonitoring: exports.transactionMonitoring,
    sanctionsScreening: exports.sanctionsScreening,
    processKYCDocument: exports.processKYCDocument
};
