...
export interface C12DAOTimelockInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "EmergencyExecuted(bytes32)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "EmergencyExecuted"): EventFragment;
...
export interface EmergencyExecutedEventObject {
  id: string;
}
export type EmergencyExecutedEvent = TypedEvent<
  [string],
  EmergencyExecutedEventObject
>;

export type EmergencyExecutedEventFilter =
  TypedEventFilter<EmergencyExecutedEvent>;
...
export interface C12DAOTimelock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: C12DAOTimelockInterface;
  ...
  filters: {
    ...
    DelayUpdated(oldDelay?: null, newDelay?: null): DelayUpdatedEventFilter;

    "EmergencyExecuted(bytes32)"(
      id?: BytesLike | null
    ): EmergencyExecutedEventFilter;
    EmergencyExecuted(id?: BytesLike | null): EmergencyExecutedEventFilter;
