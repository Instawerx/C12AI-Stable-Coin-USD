...
export interface C12DAOGovernorInterface extends utils.Interface {
  functions: {
    ...
    "QUORUM_PERCENTAGE()": FunctionFragment;
...
export interface C12DAOGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: C12DAOGovernorInterface;
  ...
  functions: {
    ...
    QUORUM_PERCENTAGE(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    QUORUM_PERCENTAGE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
