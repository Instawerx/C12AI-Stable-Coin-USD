...
export interface C12DAOInterface extends utils.Interface {
  functions: {
    ...
    "calculateVestedAmount(address)": FunctionFragment;
    "checkpoints(address,uint32)": FunctionFragment;
    "clock()": FunctionFragment;
    "createVestingSchedule(address,uint256,uint256,uint256)": FunctionFragment;
    ...
    "releaseVestedTokens()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "releaseVestedTokens",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "TokensVested(address,uint256)": EventFragment;
    "Transfer(address,address,uint256)": EventFragment;
    "Unpaused(address)": EventFragment;
    "VestingScheduleCreated(address,uint256,uint256,uint256,uint256)": EventFragment;
  };
...
export interface C12DAO extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: C12DAOInterface;
  ...
  callStatic: {
    ...
    releaseVestedTokens(overrides?: CallOverrides): Promise<void>;
